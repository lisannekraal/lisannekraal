...
function Projects() {
  ...
  return (
    <div className="container" id="section-projects">
      ...
      <Project title={t('projects.catcall.title', 'default')} image={Catcalls} github={t('projects.catcall.github', 'default')} loom={t('projects.catcall.loom')} content={t('projects.catcall.content', 'default')} stack={t('projects.catcall.stack', 'default')} />
